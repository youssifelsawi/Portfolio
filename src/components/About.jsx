...
const About = () => {
  return (
    <section id="about" className="flex justify-center align-center px-6 py-12 bg-#0a1930 text-center">
        <img src={profileImg} alt="Profile Picture" className="w-44 h-44 rounded-full mr-8"/>
        <div className="text">
